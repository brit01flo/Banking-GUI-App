...
#Main Screen
master = Tk()
master.title('The Big Five Bank')
...
#Image import
img = Image.open('C:/Users/Britney.Florence/Desktop/banking gui app/Untitled.jpg')
img = img.resize((150,150))
img = ImageTk.PhotoImage(img)

#Labels
Label(master, text = "The Big Five Bank", font=('Calibri',14)).grid(row=0,sticky=N,pady=10)
Label(master, text = "Expertise you need. Services you deserve!", font=('Calibri',12)).grid(row=1,sticky=N,pady=10)
